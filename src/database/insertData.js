...
async function saveVoo(data) {
	const voo = {
		...
		partida_prevista:
			data.partida_prevista != null
				? data.partida_prevista.toISOString()
				: null,
		partida_real:
			data.partida_real != null ? data.partida_real.toISOString() : null,
		chegada_prevista:
			data.chegada_prevista != null
				? data.chegada_prevista.toISOString()
				: null,
		chegada_real:
			data.chegada_real != null ? data.chegada_real.toISOString() : null,
